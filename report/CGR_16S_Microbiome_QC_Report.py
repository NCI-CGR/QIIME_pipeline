...
get_ipython().system('cat Q2_wrapper.sh.o*')
...
get_ipython().system('unzip -q -d taxonomic_classification/rpt_silva taxonomic_classification/barplots_classify-sklearn_silva-132-99-515-806-nb-classifier.qzv')
...
get_ipython().system('unzip -q -d denoising/feature_tables/rpt_merged_filtered_qzv denoising/feature_tables/merged_filtered.qzv')
...
get_ipython().system('unzip -q -d diversity_core_metrics/rpt_rarefaction diversity_core_metrics/rarefaction.qzv')
...
get_ipython().system('unzip -q -d diversity_core_metrics/rpt_bray-curtis_dist diversity_core_metrics/bray-curtis_dist.qza')
get_ipython().system('unzip -q -d diversity_core_metrics/rpt_weighted_dist diversity_core_metrics/weighted_dist.qza')
get_ipython().system('unzip -q -d diversity_core_metrics/rpt_unweighted_dist diversity_core_metrics/unweighted_dist.qza')
get_ipython().system('unzip -q -d diversity_core_metrics/rpt_jaccard_dist diversity_core_metrics/jaccard_dist.qza')
