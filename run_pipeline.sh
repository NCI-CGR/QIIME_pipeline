...
. /etc/profile.d/modules.sh; module load sge perl/5.18.0 python3/3.6.3 miniconda/3 jdk/15 bbmap git
unset module

cmd="qsub -q long.q -V -j y -S /bin/sh -o ${PWD} path_to_pipeline/workflow/scripts/Q2_wrapper.sh ${PWD}/config.yaml"
