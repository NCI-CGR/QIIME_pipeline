...
- Extract flat text files from denoising/feature_tables/merged.qza and denoising/sequence_tables/merged.qza
- Extract flat text files from taxonomic_classification/barplots_<...>.qzv
